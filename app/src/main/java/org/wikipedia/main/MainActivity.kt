...
class MainActivity : SingleFragmentActivity<MainFragment>(), MainFragment.Callback {
    ...
    private fun applyInsets() {
        binding.root.updatePadding(
            top = if (fragment.currentFragment is HomeFragment || fragment.currentFragment is org.wikipedia.ai.InixaAlphaFragment) 0 else statusBarInsets.top + navBarInsets.top,
